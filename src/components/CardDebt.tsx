...
export default function CardDebt({ debt, onLongPress }: CardDebtProps) {
    ...
    return (
        <TouchableOpacity style={styles.card} onLongPress={onLongPress}>
            ...
            <Text style={styles.description}>{debt.description ? debt.description : debt.category?.name}</Text>
